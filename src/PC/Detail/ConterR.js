...
require('../style/Detail/ConterR.css')
  			...
  			<div className='ConterR'>
  				<div>
					...
					<div>
						...
						<div className='selColor'>
							<span style={{height:40,marginLeft:10}}>购买方式</span>
							<ul className='selColorBox' style={{marginLeft:10}}>
								<li ><span style={{textAlign:'center'}}>官方标配</span></li>
								<li ><span style={{textAlign:'center'}}>移动优惠购</span></li>
								<li ><span style={{textAlign:'center'}}>电信优惠购</span></li>
								<li ><span style={{textAlign:'center'}}>联通优惠购</span></li>
							</ul>
						</div>
						<div className='selColor'>
							<span style={{height:40,marginLeft:10}}>白条分期</span>
							<ul className='selColorBox' style={{marginLeft:10}}>
								<li ><span style={{textAlign:'center'}}>不分期</span></li>
								<li ><span style={{textAlign:'center'}}>￥1759×3期</span></li>
								<li ><span style={{textAlign:'center'}}>￥892.5×6期</span></li>
								<li ><span style={{textAlign:'center'}}>￥459.25×12期</span></li>
							</ul>
						</div>
					</div>
					<div className='selCount'>
						...
						<button  className='ShowCart'>加入购物车</button>
					</div>
				</div>
